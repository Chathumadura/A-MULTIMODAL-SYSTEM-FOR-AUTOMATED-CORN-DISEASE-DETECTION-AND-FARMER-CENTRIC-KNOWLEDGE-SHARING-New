...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'leaf_diagnosis_title': 'Common Leaf Diagnosis',
      'leaf_diagnosis_subtitle':
          'Upload one corn leaf image and compare nutrient and disease signals together.',
      'leaf_diagnosis_pick': 'Pick Image',
      'leaf_diagnosis_capture': 'Capture',
      'leaf_diagnosis_run': 'Run Diagnosis',
      'leaf_diagnosis_result_title': 'Final Diagnosis',
      'leaf_diagnosis_nutrition_title': 'Nutrition Model Result',
      'leaf_diagnosis_disease_title': 'Disease Model Result',
      'leaf_diagnosis_fertilizer_title': 'Fertilizer Recommendation',
      'leaf_diagnosis_warning': 'Warning',
      'leaf_diagnosis_uncertain_title': 'Possible Diagnoses',
      // Capture leaf page
    ...
    'si': {
      ...
      'leaf_diagnosis': 'කොළ රෝග නිර්ණය',
      'leaf_diagnosis_title': 'සියලු කොළ නිර්ණය',
      'leaf_diagnosis_subtitle':
          'බඩඉරිඟු කොළ රූපයක් එකවර උඩුගත කර පෝෂක හා රෝග ලක්ෂණ එකට විශ්ලේෂණය කරන්න.',
      'leaf_diagnosis_pick': 'රූපය තෝරන්න',
      'leaf_diagnosis_capture': 'ගන්න',
      'leaf_diagnosis_run': 'නිර්ණය ධාවනය කරන්න',
      'leaf_diagnosis_result_title': 'අවසන් නිර්ණය',
      'leaf_diagnosis_nutrition_title': 'පෝෂක ආකෘති ප්‍රතිඵලය',
      'leaf_diagnosis_disease_title': 'රෝග ආකෘති ප්‍රතිඵලය',
      'leaf_diagnosis_fertilizer_title': 'පොහොර නිර්දේශය',
      'leaf_diagnosis_warning': 'අවවාදය',
      'leaf_diagnosis_uncertain_title': 'හැකි නිර්ණය',
      // Capture leaf page
    ...
    'ta': {
      ...
      'leaf_diagnosis_title': 'ஒருங்கிணைந்த இலை பகுப்பாய்வு',
      'leaf_diagnosis_subtitle':
          'ஒரு சோள இலை படத்தை மட்டும் பதிவேற்றி, ஊட்டச்சத்து மற்றும் நோய் அறிகுறிகளை ஒன்றாக ஒப்பிடுங்கள்.',
      'leaf_diagnosis_pick': 'படத்தைத் தேர்ந்தெடுக்கவும்',
      'leaf_diagnosis_capture': 'படமெடு',
      'leaf_diagnosis_run': 'பகுப்பாய்வை தொடங்கு',
      'leaf_diagnosis_result_title': 'இறுதி பகுப்பாய்வு',
      'leaf_diagnosis_nutrition_title': 'ஊட்டச்சத்து மாதிரி முடிவு',
      'leaf_diagnosis_disease_title': 'நோய் மாதிரி முடிவு',
      'leaf_diagnosis_fertilizer_title': 'உர பரிந்துரை',
      'leaf_diagnosis_warning': 'எச்சரிக்கை',
      'leaf_diagnosis_uncertain_title': 'சாத்தியமான முடிவுகள்',
      // Capture leaf page
